#!/usr/bin/env python3
"""
Export script for 'Le Petit Explorateur des Croyances' Lunii story pack.

Loads real assets from disk (assets/audio/, assets/images/) when available,
falls back to placeholder BMP images and silent MP3s for missing files,
then creates a Lunii-compatible ZIP archive.

Usage:
    uv run python stories/explorateur-croyances/export_pack.py
"""
...
COLOR_THEMES = {
    "cover": (70, 50, 120),  # Deep purple
    "hub-menu": (50, 80, 130),  # Navy blue
    "option-olympe": (200, 180, 100),  # Golden
    "option-nil": (180, 150, 80),  # Sandy
    "option-nord": (140, 180, 220),  # Ice blue
    "option-bouddha": (100, 170, 100),  # Forest green
    "option-voyageur": (200, 170, 100),  # Desert tan
    "option-bethlehem": (170, 140, 100),  # Warm brown
    "option-desert": (220, 180, 100),  # Golden sand
    "story-01-olympe": (200, 180, 100),
    "story-02-nil": (180, 150, 80),
    "story-03-nord": (140, 180, 220),
    "story-04-bouddha": (100, 170, 100),
    "story-05-voyageur": (200, 170, 100),
    "story-06-bethlehem": (170, 140, 100),
    "story-07-desert": (220, 180, 100),
}

# Labels for placeholder images
LABELS = {
    "cover.bmp": "Le Petit Explorateur\ndes Croyances",
    "hub-menu.bmp": "Choisis ton voyage !",
    "option-olympe.bmp": "Grece Antique\nLes Dieux de l'Olympe",
    "option-nil.bmp": "Egypte Ancienne\nLes Mysteres du Nil",
    "option-nord.bmp": "Terres Vikings\nLes Guerriers du Nord",
    "option-bouddha.bmp": "Inde Ancienne\nLe Prince Sage",
    "option-voyageur.bmp": "Desert de l'Exode\nLe Peuple Voyageur",
    "option-bethlehem.bmp": "Bethlehem\nL'Enfant Special",
    "option-desert.bmp": "Arabie\nLe Messager du Desert",
    "story-01-olympe.bmp": "Histoire 1\nLes Dieux de l'Olympe",
    "story-02-nil.bmp": "Histoire 2\nLes Mysteres du Nil",
    "story-03-nord.bmp": "Histoire 3\nLes Guerriers du Nord",
    "story-04-bouddha.bmp": "Histoire 4\nLe Prince Sage",
    "story-05-voyageur.bmp": "Histoire 5\nLe Peuple Voyageur",
    "story-06-bethlehem.bmp": "Histoire 6\nL'Enfant de Bethlehem",
    "story-07-desert.bmp": "Histoire 7\nLe Messager du Desert",
}
...
def create_silent_mp3() -> bytes:
    ...
    # MPEG1 Layer III frame header (4 bytes):
    # 0xFF 0xFB = sync word + MPEG1/Layer3/no CRC
    # 0x90 = 128kbps, 44100Hz
    # 0x00 = padding=0, stereo mode=stereo, etc.
    # Actually for mono: 0xC0 (channel mode = mono)
    #
    # More precisely:
    # FF FB = sync(11 bits) + MPEG1 + Layer3 + no CRC
    # 90 = bitrate 128kbps (1001) + sample rate 44100Hz (00) + no padding (0) + private (0)
    # 00 = mono would need specific bits
    #
    # Let's build it properly:
    # Byte 0: 0xFF (sync)
    # Byte 1: 0xFB (sync cont + MPEG1 + LayerIII + no CRC)
    # Byte 2: 0x90 = 1001 0000 = 128kbps, 44100Hz, no padding, private=0
    # Byte 3: 0xC4 = 11 000 1 00 = Mono, no mode ext, no copyright, original, no emphasis

    header = bytes([0xFF, 0xFB, 0x90, 0xC4])

    # Frame size for MPEG1 Layer III at 128kbps, 44100Hz, no padding:
    # frame_size = 144 * bitrate / sample_rate = 144 * 128000 / 44100 = 417.95... = 417 bytes
    # Minus 4 bytes header = 413 bytes of data
    frame_data_size = 413
...
def main():
    print("=" * 60)
    print("  Lunii Pack Export: Le Petit Explorateur des Croyances")
    print("=" * 60)
    print()
